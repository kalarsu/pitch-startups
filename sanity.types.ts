...
// Query: *[_type == "playlist" && slug.current == $slug][0]{  _id,  title,  slug {    current,  },  select[]->{    _id,    title,    slug {    current,    },    _createdAt,    author->{      _id,      name,      image,      bio    },    views,    description,    category,    image,  }}
