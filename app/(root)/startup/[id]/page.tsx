...
import {PLAYLIST_BY_SLUG_QUERY, STARTUP_BY_ID_QUERY, STARTUP_VIEW_QUERY} from "@/sanity/lib/queries";
...
const Page = async ({params}: { params: Promise<{ id: string }> }) => {
    ...
    // const {select: editorPosts} = await client.fetch(PLAYLIST_BY_SLUG_QUERY, { slug: 'nominees'});
            ...
            <section className="section_container">
                ...
                {editorPosts?.length > 0 && (
                    <div className="max-w-4xl mx-auto">
                        <p className="text-3-semibold">Editor Picks</p>
                ...
                <ViewWrapper id={id} views={startupViews?.views ?? 0}/>
